      ...
      if ($('').sortable) {
        ...
        return '<li data-idx="<%= node.childPos %>">' +
          '<span class="draggable line"><i class="glyphicon glyphicon-list" title="Move item"></i></span>' +
					inner +
					'<a href="#" name="<%= node.id %>" data-idx="<%= node.childPos %>" class="btn btn-default _jsonform-array-deletelast"><i data-idx="<%= node.childPos %>" class="glyphicon glyphicon-minus-sign" title="Delete last"></i></a>' +
					'<% if (node.childPos > 0) { %>' +
    ...
    'onInsert': function (evt, node) {
      ...
      $('> span > a._jsonform-array-addmore', $nodeid).click(function (evt) {
        ...
        if ((boundaries.minItems <= 0) ||
          ...
          $nodeid.find('a._jsonform-array-deletelast')
      ...
      if ((boundaries.minItems > 0) &&
        ...
        $nodeid.find('a._jsonform-array-deletelast')
          .addClass('disabled');
			...
			$($nodeid).on( "click", "a._jsonform-array-deletelast", function(evt) {
				evt.preventDefault();
				evt.stopPropagation();
